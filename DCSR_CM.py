...
if __name__ == "__main__":
    ...
    if problem==1:
        ### white noise
        cc += 0.1*np.random.randn(*cc.shape)
    elif problem==2:
        ## Pink noise
        cc += 0.1 * generate_batch_pink_noise(cc.shape[0], cc.shape[1])
    elif problem==3:
        ## brown noise
        cc += 0.1 * generate_batch_brown_noise(cc.shape[0], cc.shape[1])
    ...
    # eps1, eps2, eps3 = 1e-3, 1e-3, 1e-3
    # method1, method2, method3 = 'EM_cond', 'EM_cond', 'EM_cond'
    ...
    ls = transfer_sdit_super(marginal_prob_std_fn_s, diffusion_coeff_fn_s, marginal_prob_std_fn_b,
                             ...
                             model_up_0=model_up_0, model_up_1=model_up_1, model_up_2=model_up_2, method1=method1,
                             method2=method2, method3=method3, eps1=eps1, eps2=eps2, eps3=eps3)
    ...
    c_res_ls = direct_super(marginal_prob_std_fn_s, diffusion_coeff_fn_s, points_x_0, points_x_1, points_x_2, points_x,
                            L, eps, t, X, model_up_0, model_up_1=model_up_1, model_up_2=model_up_2, method1=method1,
                            method2=method2, method3=method3, eps1=eps1, eps2=eps2, eps3=eps3)
    ...
    RMSE_sdit, MMD_sdit, TVD_sdit, melr_u_sdit, melr_w_sdit, k_vec, log_sdit = compute_all_error(pd_256, real_256,
                                                                                                 max_k=80)
    cwd = os.getcwd()
    log_name = cwd + '/figs/CM_Error_res_type'+ type+ '_problem_' + str(problem) + '.txt'
    fig_name_process = cwd + '/figs/CM_process_type'+ type+ '_problem_' + str(problem) + '.png'
    fig_name_ins = cwd + '/figs/CM_ins_problem_type'+ type+ '_problem_' + str(problem) + '.png'
    fig_name_spectral = cwd + '/figs/CM_spectral_problem_type'+ type+ '_problem_' + str(problem) + '.png'
    npy_name = cwd + '/figs/CM_type_'+ type+ '_problem_' + str(problem) + '.npy'
