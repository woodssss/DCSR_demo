...
Ori_data_name_high = cwd + '/raw_data/Wind_high_1.npy'
Ori_data_name_test = cwd + '/raw_data/Wind_high_2.npy'

Gen_data = cwd + '/data/WD_gen_data_N_' + num2str_deciaml(N_gen) + '.npy'
Super_data = cwd + '/data/WD_super_data_N_' + num2str_deciaml(N_sup) + '.npy'
Super_test_data = cwd + '/data/WD_super_test_data_N_' + num2str_deciaml(N_test) + '.npy'
Test_data = cwd + '/data/WD_test_data_N_' + num2str_deciaml(N_test) + '.npy'
