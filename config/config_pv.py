...
## two dataset: set 1: high resolution high fidelity dataset: mat_f
## set 2: uncorrespond low fidelity dataset: [tmat_l_white, pink, brown] and tmat_f
Ori_data_name_high = cwd + '/raw_data/Potential_vorticity_high_1.npy'
Ori_data_name_test = cwd + '/raw_data/Potential_vorticity_high_2.npy'

Gen_data = cwd + '/data/PV_gen_data_N_' + num2str_deciaml(N_gen) + '.npy'
Super_data = cwd + '/data/PV_super_data_N_' + num2str_deciaml(N_sup) + '.npy'
Super_test_data = cwd + '/data/PV_super_test_data_N_' + num2str_deciaml(N_test) + '.npy'
Test_data = cwd + '/data/PV_test_data_N_' + num2str_deciaml(N_test) + '.npy'
