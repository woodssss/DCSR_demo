...
if __name__ == "__main__":
    ...
    load_epoch_gen, load_epoch_0, load_epoch_1= 2000, 2000, 800
    #load_epoch_2 = 2000
    load_epoch_2 = 350
    ...
    RMSE_c, MMD_c, TVD_c, melr_u_c, melr_w_c, k_vec, log_c = compute_all_error(c_256, real_256, max_k=128)
    ...
    log_name = 'NS_Error_res_problem_' + str(problem) + '.txt'
